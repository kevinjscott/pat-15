...
class Extractor:
    ...
    def extract_data_step_1(self, page_data, player):
        ...
        extracted_data = self.openai_handler.chat(basic_prompt, "link_to_player: " + player['link'] + " \\n" + "Today's Date: " + datetime.now().strftime('%Y-%m-%d') + " \\n" + json.dumps(player) + " \\n" + page_data)
    ...
    def extract_data_step_2(self, step_1_results, player):
        ...
        extracted_data = self.openai_handler.chat(system_prompt, step_1_results, "gpt-3.5-turbo")
